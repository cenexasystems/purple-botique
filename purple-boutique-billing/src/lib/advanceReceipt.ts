...
export function advanceReceiptPdf(order: AdvanceOrder) {
  ...
  doc.setTextColor('#4c1d95'); doc.setFont('helvetica', 'bold'); doc.setFontSize(18); doc.text(BRAND_EN.toUpperCase(), 38, 20)
