...
export default function Checkout() {
  ...
  const handleCheckout = async () => {
    ...
    if (!isValidPhone(form.phone)) {
      setError('Please enter a valid Malaysian WhatsApp number (e.g. 0123456789 or +60 0123456789)')
      return
    }
          ...
          <div className="surface-panel p-4 sm:p-6 h-fit">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {form.phone && isValidPhone(form.phone) && (
                  <p className="mt-1 text-xs text-green-600 font-medium">✓ Valid Malaysian mobile number</p>
                )}
              </div>
