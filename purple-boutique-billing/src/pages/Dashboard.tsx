    ...
    <div className="admin-shell h-full bg-bgMain flex flex-col lg:flex-row">
      ...
      >
        ...
        <div className={`hidden lg:flex items-center relative transition-all duration-300 ${sidebarCollapsed ? 'flex-col items-center pt-5 pb-4 px-2 gap-3' : 'px-5 py-5 justify-between'}`}>
          <Link to="/dashboard" title="Go to Dashboard" className={`flex items-center gap-3 min-w-0 transition-all duration-300 ${sidebarCollapsed ? 'justify-center' : 'flex-1'}`}>
        ...
        <div className="flex lg:hidden items-center justify-between px-4 py-4 border-b border-white/10">
          <Link to="/dashboard" title="Go to Dashboard" className="flex items-center gap-3 min-w-0">
